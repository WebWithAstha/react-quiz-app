  ...
  return (
    ...
    <div className='px-8 py-8'>
      ...
      <div className="min-h-40 flex  gap-2 rounded-lg items-center justify-center border-4 border-sky-500/[.1] bg-sky-500/[.4] shadow mt-6 px-4 py-4">
        <img className='w-28' src={correct.length < 5 ? "https://cdn-icons-png.flaticon.com/512/2395/2395707.png" : correct.length < 7 ? "https://cdn-icons-png.flaticon.com/512/2395/2395711.png" : "https://cdn-icons-png.flaticon.com/512/2395/2395703.png"} alt="" />
      ...
      <div className=" flex  gap-2 rounded-lg items-center border-4 border-zinc-200/[.1] bg-zinc-400/[.1] shadow mt-6 px-4 py-4">
        ...
        <div className="w-1/3 flex flex-col items-center border-r">
          ...
          <div className="w-12 h-12 rounded-full border-4 border-blue-500/[.4] shadow-md bg-blue-50 flex justify-center items-center text-md font-bold">0 </div>
        </div>
        <div className="w-1/3 flex flex-col items-center">
          <h1 className='leading-tight px-1 font-medium mb-1 text-md'>Incorrect</h1>
          <div className="w-12 h-12 rounded-full border-4 border-red-500/[.4] shadow-md bg-red-50 flex justify-center items-center text-md font-bold">{userQuizData.questions.length - correct.length}</div>
        </div>
      </div>
